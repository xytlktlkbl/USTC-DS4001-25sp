...
from submission import ParticleFilter, ExactInference, LikelihoodWeighting
...
class Agent(Car):
    ...
    def getInference(self):
        if not self.hasInference:
            ...
            elif Const.INFERENCE == 'LikelihoodWeighting':
                self.inference = LikelihoodWeighting(rows, cols)
