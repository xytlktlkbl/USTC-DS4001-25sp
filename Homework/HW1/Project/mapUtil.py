...
def createUSTCMap() -> CityMap:
    cityMap = readMap("data/USTC-Main_Campus.pbf")
    addLandmarks(cityMap, "data/USTC-landmarks.json")
    return cityMap

def createHefeiMap() -> CityMap:
    cityMap = readMap("data/Hefei.pbf")
    addLandmarks(cityMap, "data/Hefei-landmarks.json")
    return cityMap
